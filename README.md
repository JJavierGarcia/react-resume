[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=JJavierGarcia_react-resume&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=JJavierGarcia_react-resume)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=JJavierGarcia_react-resume&metric=coverage)](https://sonarcloud.io/summary/new_code?id=JJavierGarcia_react-resume)
